"""Cross-encoder reranking of FiQA hybrid candidates."""
...
OUTPUT_PATH = "results/fiqa/hybrid_cross_encoder_per_query.jsonl"
...
def main() -> None:
    ...
    print("Cross-encoder reranking / FiQA")
    print(f"model: {MODEL_NAME}")
    print("candidate source: hybrid RRF")
